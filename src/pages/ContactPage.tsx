    ...
    <div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-200 via-blue-200 to-purple-300 flex flex-col items-center p-6">
        ...
        <section className="max-w-4xl text-center mb-12">
          <h1 className="text-5xl font-extrabold mb-8 text-purple-800">Contact Us</h1>
        ...
        <section className="w-full max-w-4xl flex flex-col md:flex-row bg-white shadow-lg rounded-lg p-8 mb-12">
          <form onSubmit={handleSubmit} className="flex-1 mb-8 md:mb-0 md:mr-8">
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full p-3 border rounded focus:ring-4 focus:ring-purple-300"
                required
              />
            </div>
            <div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                onChange={handleChange}
                className="w-full p-3 border rounded h-32 focus:ring-4 focus:ring-purple-300"
                required
              />
            </div>
            <button type="submit" className="w-full bg-purple-500 text-white p-3 rounded hover:bg-purple-600 transition-colors duration-300">
              Send Message
            </button>
          </form>
